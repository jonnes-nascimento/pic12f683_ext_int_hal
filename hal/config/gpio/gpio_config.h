...
typedef union
{
    ...
    struct
    {        
        uint8_t BIT0 : 1;    /**< Gpio port bit 5 (GP0) */
        uint8_t BIT1 : 1;    /**< Gpio port bit 4 (GP1) */
        uint8_t BIT2 : 1;    /**< Gpio port bit 3 (GP2) */
        uint8_t BIT3 : 1;    /**< Gpio port bit 2 (GP3) */
        uint8_t BIT4 : 1;    /**< Gpio port bit 1 (GP4) */
        uint8_t BIT5 : 1;    /**< Gpio port bit 0 (GP5) */
